        ...
        React.createElement("ul", null,
                ...
                this.props.items.map(function(item) {
                    if(item.items.length == 0)
                        return React.createElement("li", null, React.createElement(SectionLink, {title: item.title, contentLink: item.CL, instructions: item.GL, templateLink: item.TL}))
                    else
                        return (
                        React.createElement("li", null, React.createElement(SectionLink, {title: item.title, contentLink: item.CL, instructions: item.GL, templateLink: item.TL}),
